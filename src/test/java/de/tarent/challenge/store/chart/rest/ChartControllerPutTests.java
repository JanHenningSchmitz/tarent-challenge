...
public class ChartControllerPutTests extends ChartControllerTests {
	...
	public void checkOutChart() throws Exception {
		// this.mockMvc.perform(put("/charts/" + TESTCHARTS[0].getName() +
	...
	// private ResultActions deleteItemsFromChart(String chartname, Chartitem
	// chartitem) throws Exception {
	//
	// String json = json(chartitem);
	//
	// return this.mockMvc.perform(put("/charts/" + chartname +
	// "/delete").contentType(contentType).content(json));
	// }
	//
	// private ResultActions addItemsToChart(String chartname, Chartitem chartitem)
	// throws Exception {
	//
	// String json = json(chartitem);
	//
	// return this.mockMvc.perform(put("/charts/" + chartname +
	// "/add").contentType(contentType).content(json));
	// }
}
